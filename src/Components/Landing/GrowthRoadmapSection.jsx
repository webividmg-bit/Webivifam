...
const STEPS = [
  { id: 1, label: "Discover", align: "justify-end pl-16", variant: "solid" },
  { id: 2, label: "Strategize", align: "justify-start pr-12", variant: "solid" },
  { id: 3, label: "Build", align: "justify-center px-8", variant: "outline" },
  { id: 4, label: "Launch", align: "justify-start pr-16", variant: "solid" },
  { id: 5, label: "Optimize", align: "justify-center px-8", variant: "outline" },
  { id: 6, label: "Scale", align: "justify-end pl-12", variant: "solid" },
];
    ...
    <section className="relative w-full overflow-hidden py-20 lg:py-28 bg-black">
      <div className="relative z-10 mx-auto max-w-[1280px] px-6 sm:px-10 lg:px-16">
        <div className="relative flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
          ...
          {/* Background Blueprint Rectangles extending behind text & ladder */}
          <svg
          ...
          {/* Left Column: Heading, Body Text & Link */}
